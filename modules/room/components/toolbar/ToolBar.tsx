...
const ToolBar = () => {
  ...
  return (
    <>
      <motion.button
        className="btn-icon absolute bottom-1/2 -left-2 z-50 h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-blue text-lg sm:text-2xl transition-none lg:hidden"
      ...
      <motion.div
        className="absolute left-2 sm:left-10 top-[50%] z-50 grid grid-cols-2 items-center gap-3 sm:gap-5 rounded-lg bg-gradient-to-r from-zinc-900 to-indigo-800 dark:bg-gray-800 p-3 sm:p-5 text-white border border-gray-700 dark:border-gray-600 2xl:grid-cols-1"
        animate={{
          x: opened ? 0 : -160,
          y: "-50%",
        }}
